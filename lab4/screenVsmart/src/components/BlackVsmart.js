...
const BlackVsmart = props => {
    return (
      <View style={styles.container}>
        <Image
          source={require("../components/images/vsmart_black_star1.png")}
          style={styles.imgBlackVsmart}
        />
        ...
        <TouchableOpacity
          ...
          onPress={() => props.navigation.navigate("ChooseColorVsmart")}
        >
